...
def uniformCostSearch(problem):
    ...
    pqf = util.PriorityQueueWithFunction(lambda item : problem.getCostOfActions(item[1]))
    return search(problem,pqf)
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    pqf = util.PriorityQueueWithFunction(lambda item : problem.getCostOfActions(item[1]) + heuristic(item[0],problem))
    return search(problem,pqf)
